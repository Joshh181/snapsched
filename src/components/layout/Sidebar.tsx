...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-52 bg-zinc-100/90 border-r border-zinc-200 flex flex-col justify-between shrink-0 h-screen sticky top-0 z-30 select-none backdrop-blur-md">
      {/* Top: Brand & Workspace */}
      <div>
        {/* Brand Header */}
        ...
        <nav className="p-2 space-y-0.5">
          <div className="px-2 py-1 text-[9px] font-semibold uppercase tracking-wider text-zinc-600 font-mono">
            Navigation
          </div>
          {navItems.map((item) => {
        ...
        <div className="p-2 rounded-md bg-white border border-zinc-200/80 shadow-2xs space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-1 text-center">
            <div className="p-1 rounded bg-zinc-50 border border-zinc-150">
              ...
              <div className="text-[9px] text-zinc-600 font-medium">Classes</div>
            </div>
            <div className="p-1 rounded bg-zinc-50 border border-zinc-150">
              <div className="text-xs font-mono font-semibold text-amber-600">{vacantCount}</div>
              <div className="text-[9px] text-zinc-600 font-medium">Breaks</div>
            </div>
          </div>
        </div>
