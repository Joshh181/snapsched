...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Floating Card Sidebar Column */}
      <aside
        className={`
          fixed top-0 left-0 bottom-0 w-[270px] z-50 p-3 lg:p-0
          bg-slate-50/95 lg:bg-transparent overflow-y-auto
          transition-transform duration-300
          lg:static lg:w-[270px] lg:translate-x-0 lg:z-auto
          flex flex-col gap-4 shrink-0
          ${isOpen ? 'translate-x-0' : '-translate-x-full'}
        `}
      >
        {/* Card 1: Main Sidebar (Preserves all original internal space) */}
        <div className="bg-white select-none rounded-3xl shadow-card border border-white/80 p-4 flex flex-col justify-between h-[calc(100vh-2rem)] shrink-0">
          {/* Top section */}
          ...
          {/* Bottom section: Mobile Weather Widget (on top) & Summary Card */}
          <div className="pt-3 space-y-3">
            {/* Mobile Only: Weather Widget on top */}
            <div className="block lg:hidden">
              <WeatherWidget />
            </div>

            {/* Total Units & Classes Summary Card */}
            <div className="p-3 rounded-2xl bg-gradient-to-br from-slate-50 to-indigo-50/30 border border-slate-100/80">
        ...
        {/* Card 2 (Desktop Only): Standalone Real-Time Weather Widget underneath sidebar */}
