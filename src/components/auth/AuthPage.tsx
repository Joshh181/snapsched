        ...
        <div className="lg:col-span-6 w-full max-w-[430px] mx-auto">
          ...
          >
            ...
            <button
              ...
              type="button"
              className="w-full py-2.5 px-4 rounded-xl font-bold text-[13.5px] text-slate-700 bg-white hover:bg-slate-50/90 border border-slate-200/90 shadow-2xs hover:shadow-xs flex items-center justify-center gap-3 transition-all hover:scale-101 active:scale-99"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11.5px] text-slate-400 font-semibold uppercase tracking-wider">or with email</span>
              <div className="flex-1 h-px bg-slate-200/90" />
            </div>
